...
// import type { NavigationScreenParams } from '@react-navigation/core'
...
export const types = {
  ...
  BACK: 'GO_BACK', // CommonActions.BACK,
  NAVIGATE: 'NAVIGATE', // CommonActions.NAVIGATE,
  PUSH: 'PUSH', // CommonActions.PUSH,
  SET_PARAMS: 'SET_PARAMS', // CommonActions.SET_PARAMS,
...
export type ResolveConditionsResult<STATE> = {
  navigationAction: NavigationAction,
  conditionalNavigationState: ConditionalNavigationState<STATE>,
}
